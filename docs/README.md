# Documentation - Exile Reborn

Index de la documentation du projet. Voir aussi [CLAUDE.md](../CLAUDE.md) à la racine pour les instructions destinées à Claude Code.
...
- [database/README.md](database/README.md) — schémas, tables, documentation générée (SchemaSpy).
- [development/database.md](development/database.md) — commandes d'import, de réinitialisation et de connexion.
